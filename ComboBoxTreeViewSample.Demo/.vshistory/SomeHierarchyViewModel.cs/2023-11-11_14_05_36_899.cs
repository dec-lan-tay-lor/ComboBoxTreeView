...
{
    public class ierarchyViewModel : ITreeViewItemModel
    {
        public ierarchyViewModel(string title, List<ierarchyViewModel> children, ierarchyViewModel parent = null)
        {
            this.Title = title;
            this.Parent = parent;
        ...
        public ierarchyViewModel Parent { get; set; }

        public List<ierarchyViewModel> Children { get; set; }
        ...
        private IEnumerable<ierarchyViewModel> GetAscendingHierarchy()
        {
            var vm = this;
